...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-deep-night text-white/70">
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="flex flex-col md:flex-row gap-10 items-start justify-between">
            ...
            <div className="flex gap-10">
              <div>
                <h4 className="text-white/90 text-xs uppercase tracking-widest font-medium mb-4">
                  Navigation
                </h4>
            ...
            <button
              ...
              className="bg-bloom-pink text-white text-sm font-medium px-6 py-3 rounded-full hover:bg-bloom-pink-dark transition-colors cursor-pointer"
            >
              Book a Session
            </button>
          </div>
